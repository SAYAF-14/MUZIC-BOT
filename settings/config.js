module.exports = {
  TOKEN: (process.env.TOKEN),//secrets
  PREFIX: process.env.PREFIX,//secrets
  embed: {
    color: process.env.color,//secrets
    color2: process.env.color2,//secrets
    color3: process.env.color3,//secrets
    wrongcolor: process.env.wrongcolor,//secrets
    footertext: "** Coded By Alshami | @sayaf14 **",
  },
  emoji: {
    ERROR: "❌",
    SUCCESS: "✅",
  ...
  // others
  mongodb: (process.env.MONGO_URL),//secrets
  filters: {
  ...
  links: {
    ...
    DiscordServer: process.env.DiscordServer || `https://discord.gg/6ypRgpGas7`,
    VoteURL: process.env.VoteURL || `https://discord.gg/6ypRgpGas7`,
    Website: `https://www.youtube.com/@sayaf_alshami`,
  },
  options: {
    embedFooter: true,
    nowplayingMsg: true,
  ...
  slash: {
    global: false,
    guildID: process.env.GUILD_ID,//secrets for slash command
  },
};
